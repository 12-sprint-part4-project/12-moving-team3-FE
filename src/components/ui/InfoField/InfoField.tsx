 ...
 * color(배경/글자 색상 프리셋)을 제외한 크기/패딩/폰트 등은 기본값을 두지 않고
...
export const InfoField = ({
  ...
  <dl className={cn('inline-flex min-w-0 items-center gap-3', className)}>
    <dt
      className={cn(
        'inline-flex shrink-0 items-center justify-center rounded-sm whitespace-nowrap',
        COLOR_STYLE[color],
        labelClassName
      )}
    >
