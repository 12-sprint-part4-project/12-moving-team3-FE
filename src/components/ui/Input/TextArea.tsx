...
export const TextArea = ({
  ...
  return (
    <div className={cn('flex w-full flex-col gap-1', className)}>
      <div
        className={cn(
          'flex flex-col overflow-clip rounded-2xl border bg-background-200',
      ...
      >
        <textarea
          ...
          className={cn(
            'min-h-0 w-full flex-1 resize-none bg-transparent outline-none placeholder:text-gray-300 disabled:cursor-not-allowed',
      ...
      {errorMessage ? (
        <p className={cn('pl-2 text-red-200', sizeStyles[size].error)}>
          {errorMessage}
        </p>
      ) : null}
    </div>
