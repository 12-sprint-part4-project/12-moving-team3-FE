...
export const PendingRequestSubHeaderSkeleton = () => (
  <div role="status" aria-busy="true" aria-label="요청 정보 불러오는 중">
    <section
    ...
    >
      <div className="flex w-full flex-col items-start justify-end gap-5 md:gap-7 lg:flex-row lg:items-end lg:gap-5">
        <div className="flex w-full flex-col items-start gap-2 lg:min-w-0 lg:flex-1">
          <div className="h-6 w-24 animate-pulse rounded bg-background-200 md:h-8 md:w-28" />
          <div className="h-4 w-40 animate-pulse rounded bg-background-200 md:h-5 md:w-48" />
        </div>
        ...
        <div className="flex w-full flex-col gap-2 md:hidden">
          {Array.from({ length: 3 }, (_, index) => (
            ...
            >
              ...
              <div className="h-4 w-28 animate-pulse rounded bg-background-200" />
            </div>
          ))}
        </div>
        ...
        <div className="hidden shrink-0 items-start gap-10 md:flex md:w-full lg:w-auto">
          <div className="flex shrink-0 items-end gap-3">
            <div className="flex flex-col gap-2">
              <div className="h-5 w-12 animate-pulse rounded bg-background-200" />
              <div className="h-6 w-24 animate-pulse rounded bg-background-200" />
            </div>
            <div className="mb-[0.1875rem] h-5 w-2 animate-pulse rounded bg-background-200" />
            <div className="flex flex-col gap-2">
              <div className="h-5 w-12 animate-pulse rounded bg-background-200" />
              <div className="h-6 w-24 animate-pulse rounded bg-background-200" />
            </div>
          ...
          <div className="flex flex-col gap-2">
            <div className="h-5 w-12 animate-pulse rounded bg-background-200" />
            <div className="h-6 w-36 animate-pulse rounded bg-background-200" />
          </div>
        </div>
      </div>
    </section>
...
const HistoryQuoteCardSkeleton = () => (
  ...
  >
    <div className="flex w-full items-center justify-between gap-2 lg:gap-3">
      ...
      <div className="hidden h-4 w-16 shrink-0 animate-pulse rounded bg-background-200 md:block" />
    </div>
    <div className="flex flex-col gap-2">
    ...
    <div className="flex w-full items-end justify-end gap-2 lg:h-10 lg:gap-4">
      <div className="h-5 w-16 animate-pulse rounded bg-background-200 lg:h-6" />
      <div className="h-7 w-28 animate-pulse rounded bg-background-200 lg:h-8 lg:w-36" />
    </div>
    <div className="flex w-full flex-col gap-2 md:flex-row md:gap-3">
      <div className="h-12 w-full animate-pulse rounded-lg bg-background-200 lg:h-14 lg:rounded-2xl" />
      <div className="h-12 w-full animate-pulse rounded-lg bg-background-200 lg:h-14 lg:rounded-2xl" />
    </div>
  </div>
);
