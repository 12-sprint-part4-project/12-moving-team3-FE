...
export const COMMUNITY_FURNITURE_SHARE_CTA_ICON_CLASS =
  'size-6 shrink-0 text-yellow-100 min-[46.5rem]:size-7 xl:size-8';

export const COMMUNITY_FURNITURE_SHARE_CTA_CHECK_ICON_CLASS =
  '[&_path]:stroke-[1]';

export const COMMUNITY_FURNITURE_SHARE_CTA_LABEL_CLASS =
  'text-md-semibold text-black-400 min-[46.5rem]:text-lg-semibold xl:text-2lg-semibold';
