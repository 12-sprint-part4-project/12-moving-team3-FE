    ...
    <section className={className}>
      ...
      <div className={COMMUNITY_WRITE_TITLE_FIELD_WRAPPER_CLASS}>
        ...
        <input
          ...
          placeholder={readOnly ? undefined : t('community.titlePlaceholder')}
